...
for percentage in percentages:
    for ratio, ratio_text in zip(ratios, ratios_text):  # Iterate over train-test split ratios
        ...
        df = pd.read_csv("IndirectBP/stats_raytrace_IndirectBP_16/Data-traffic-distribution-Comparison.csv")
        ...
        out.to_csv("IndirectBP/stats_raytrace_IndirectBP_16/Data-traffic-distribution-Results.csv", header=False, index=False, mode='a')  # Save the result